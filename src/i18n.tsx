...
const de: Dict = {
  ...
  "offer.yourDetails": "Angaben Ihres Kunden",
  ...
  "pdf.yourRoof": "Ihr Dach – Satellitenansicht",
  "pdf.tagline": "Ihr persönliches Dach-Angebot",
  "pdf.satAttribution": "Luftbild © Esri, Maxar",
...
const en: Dict = {
  ...
  "offer.yourDetails": "Your customer's details",
  ...
  "pdf.yourRoof": "Your roof – satellite view",
  "pdf.tagline": "Your personal roofing offer",
  "pdf.satAttribution": "Imagery © Esri, Maxar",
  "pdf.position": "Item",
  "pdf.qty": "Qty",
  "pdf.unit": "Unit price",
  "pdf.amount": "Amount",
